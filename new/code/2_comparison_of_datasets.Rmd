...
- import_total.xlsx group variable: What is group? its in this data file and in the original r script but never used in the analyses.
...
dir.create("plots")
ggsave("plots/plot_data_comparisons.png", width = 8, height = 12)

```

- TSSQ seems to recalculate fine
- IRI and MES produce very different sum scores to that used in the analytic dataset
